...
namespace game
{
    ...
    void rendermovables()
    {
        loopv(movables)
        {
            ...
            if(!mdlname) continue;
			rendermodel(mdlname, ANIM_MAPMODEL|ANIM_LOOP, o, m.yaw, 0, 0, MDL_CULL_VFC | MDL_CULL_DIST | MDL_CULL_OCCLUDED, &m);
        }
    }
    ...
    void hitmovable(int damage, movable *m, gameent *at, const vec &vel, int gun)
    {
